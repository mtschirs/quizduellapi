...
(*Inofficial*) Interface to the Quizduell web API written in Python and distributed under LGPLv3. Start games, answer questions, read user statistics and more.
